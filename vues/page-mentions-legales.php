...
<?php
    $_RAISON_SOCIALE = "M.C.F. - Macip Conseils et Finances";
    $_CAPITAL = "400,00";
    $_RCS = "RCS B&eacute;ziers 949 656 532";
    $_ADRESSE_SIEGE_SOCIAL = "9 bis, rue Ermengaud - 34 500 BEZIERS";
    $_TELEPHONE = "06 63 62 70 45";
    $_MAIL = "macip.conseil.finance@gmail.com";
    $_TVA = "FR68949656532 (activit&eacute; non assujettie &agrave; la TVA)";
